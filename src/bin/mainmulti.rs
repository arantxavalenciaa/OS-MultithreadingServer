...
use std::{
    ...
    time::Duration, //Tiempo para retraso entre las peticiones
};
...
fn handle_connection(mut stream: TcpStream) {
    ...
    let (status_line, filename) = match &request_line[..] { "GET / HTTP/1.1" =>
        ("HTTP/1.1 200 OK", "Respuesta.html"), "GET /sleep HTTP/1.1" => {
